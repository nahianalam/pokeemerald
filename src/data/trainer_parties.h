...
static const struct TrainerMonItemCustomMoves sParty_Sidney[] = {
    ...
    .moves = {MOVE_EXTREME_SPEED, MOVE_DOUBLE_EDGE, MOVE_SAND_ATTACK, MOVE_CRUNCH}
    },
    {
    .iv = 250,
    .lvl = 48,
    ...
    .moves = {MOVE_TORMENT, MOVE_LEAF_BLADE, MOVE_SWAGGER, MOVE_GIGA_DRAIN}
    },
    {
    .iv = 250,
    .lvl = 46,
    ...
    .moves = {MOVE_EGG_BOMB, MOVE_PURSUIT, MOVE_NEEDLE_ARM, MOVE_DOUBLE_TEAM}
    },
    {
    .iv = 250,
    .lvl = 48,
    ...
    .moves = {MOVE_CRUNCH, MOVE_CONFUSE_RAY, MOVE_PSYBEAM, MOVE_DOUBLE_TEAM}
    },
    {
    .iv = 255,
    .lvl = 49,
    ...
    .moves = {MOVE_AERIAL_ACE, MOVE_FURY_CUTTER, MOVE_SWORDS_DANCE, MOVE_SLASH}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Phoebe[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHADOW_PUNCH, MOVE_CONFUSE_RAY, MOVE_CURSE, MOVE_WILL_O_WISP}
    },
    {
    .iv = 250,
    .lvl = 49,
    .species = SPECIES_BANETTE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHADOW_BALL, MOVE_GRUDGE, MOVE_WILL_O_WISP, MOVE_DOUBLE_TEAM}
    },
    {
    .iv = 250,
    .lvl = 50,
    ...
    .moves = {MOVE_SHADOW_BALL, MOVE_THUNDERBOLT, MOVE_HYPNOSIS, MOVE_SLUDGE_BOMB}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Glacia[] = {
    ...
    .moves = {MOVE_ICE_PUNCH, MOVE_PSYCHIC, MOVE_HAIL, MOVE_SHADOW_BALL}
    },
    {
    .iv = 250,
    .lvl = 50,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_LIGHT_SCREEN, MOVE_ICE_BEAM, MOVE_ICICLE_SPEAR, MOVE_SPIKE_CANNON}
    },
    {
    .iv = 250,
    .lvl = 52,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ATTRACT, MOVE_SURF, MOVE_HAIL, MOVE_BLIZZARD}
    },
    {
    .iv = 250,
    .lvl = 52,
...
static const struct TrainerMonItemCustomMoves sParty_Drake[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FLY, MOVE_DRAGON_CLAW, MOVE_THUNDER, MOVE_BLIZZARD}
    },
    {
    .iv = 250,
    .lvl = 54,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ICE_BEAM, MOVE_DRAGON_BREATH, MOVE_DRAGON_DANCE, MOVE_AERIAL_ACE}
    },
    {
    .iv = 250,
    .lvl = 53,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SMOKESCREEN, MOVE_DRAGON_DANCE, MOVE_SURF, MOVE_DRAGON_BREATH}
    },
    {
    .iv = 250,
    .lvl = 53,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FLAMETHROWER, MOVE_FIRE_BLAST, MOVE_DRAGON_CLAW, MOVE_EARTHQUAKE}
    },
    {
    .iv = 255,
    .lvl = 55,
