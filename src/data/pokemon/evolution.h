const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_PIKACHU]    = {{EVO_LEVEL, 25, SPECIES_RAICHU}},
    ...
    [SPECIES_JIGGLYPUFF] = {{EVO_LEVEL, 30, SPECIES_WIGGLYTUFF}},
    ...
    [SPECIES_GLOOM]      = {{EVO_FRIENDSHIP_NIGHT, 0, SPECIES_VILEPLUME},
    ...
    [SPECIES_GROWLITHE]  = {{EVO_LEVEL, 36, SPECIES_ARCANINE}},
    [SPECIES_POLIWAG]    = {{EVO_LEVEL, 20, SPECIES_POLIWHIRL}},
    [SPECIES_POLIWHIRL]  = {{EVO_LEVEL_ATK_GT_DEF, 32, SPECIES_POLIWRATH},
                            {EVO_LEVEL_ATK_LT_DEF, 32, SPECIES_POLITOED}},
    ...
    [SPECIES_MACHOKE]    = {{EVO_LEVEL, 32, SPECIES_MACHAMP}},
    ...
    [SPECIES_SLOWPOKE]   = {{EVO_LEVEL, 22, SPECIES_SLOWBRO}},
    ...
    [SPECIES_STARYU]     = {{EVO_LEVEL, 28, SPECIES_STARMIE}},
    [SPECIES_SCYTHER]    = {{EVO_LEVEL, 32, SPECIES_SCIZOR}},
    ...
    [SPECIES_PORYGON]    = {{EVO_LEVEL, 28, SPECIES_PORYGON2}},
    ...
    [SPECIES_TOGEPI]     = {{EVO_LEVEL, 25, SPECIES_TOGETIC}},
    ...
    [SPECIES_SMOOCHUM]   = {{EVO_LEVEL, 15, SPECIES_JYNX}},
    [SPECIES_ELEKID]     = {{EVO_LEVEL, 15, SPECIES_ELECTABUZZ}},
    [SPECIES_MAGBY]      = {{EVO_LEVEL, 15, SPECIES_MAGMAR}},
    [SPECIES_LARVITAR]   = {{EVO_LEVEL, 30, SPECIES_PUPITAR}},
    [SPECIES_PUPITAR]    = {{EVO_LEVEL, 42, SPECIES_TYRANITAR}},
    ...
    [SPECIES_LOMBRE]     = {{EVO_LEVEL, 30, SPECIES_LUDICOLO}},
    ...
    [SPECIES_SKITTY]     = {{EVO_LEVEL, 28, SPECIES_DELCATTY}},
    ...
    [SPECIES_FEEBAS]     = {{EVO_LEVEL, 18, SPECIES_MILOTIC}},
    ...
    [SPECIES_AZURILL]    = {{EVO_LEVEL, 32, SPECIES_MARILL}},
    ...
    [SPECIES_CLAMPERL]   = {{EVO_LEVEL_ATK_EQ_DEF, 30, SPECIES_HUNTAIL},
                            {EVO_LEVEL_ATK_LT_DEF, 30, SPECIES_GOREBYSS}},
    [SPECIES_SHUPPET]    = {{EVO_LEVEL, 36, SPECIES_BANETTE}},
    ...
    [SPECIES_SHELGON]    = {{EVO_LEVEL, 42, SPECIES_SALAMENCE}},
    [SPECIES_BELDUM]     = {{EVO_LEVEL, 20, SPECIES_METANG}},
    [SPECIES_METANG]     = {{EVO_LEVEL, 42, SPECIES_METAGROSS}},
};
